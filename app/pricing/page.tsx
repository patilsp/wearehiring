...
const Pricing = () => {
  return (
    <section className="dark:bg-dark relative z-10 overflow-hidden pb-12 pt-20 lg:pb-[90px] lg:pt-[120px]">
  ...
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="border-stroke shadow-pricing dark:border-dark-3 dark:bg-dark relative z-10 mb-10 overflow-hidden rounded-[10px] border-2 px-8 py-10 sm:p-12 lg:px-6 lg:py-10 xl:p-[50px]">
          ...
          <a
            ...
            className={` ${
              active
                ...
                : "border-stroke dark:border-dark-3 block w-full rounded-md border bg-transparent p-3 text-center text-base font-medium text-primary transition hover:border-primary hover:bg-primary hover:text-white"
            } `}
          >
            {buttonText}
          </a>
